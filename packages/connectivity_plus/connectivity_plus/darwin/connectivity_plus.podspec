...
Downloaded by pub (not CocoaPods).
  ...
  s.ios.resource_bundles = {'connectivity_plus_privacy' => ['Resources/PrivacyInfo.xcprivacy']}
  s.osx.resource_bundles = {'connectivity_plus_privacy' => ['Resources/PrivacyInfo.xcprivacy']}
